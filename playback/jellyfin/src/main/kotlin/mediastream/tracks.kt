...
fun MediaInfo.getMediaStreamContainer() =
...
fun MediaStream.getMediaStreamTrack() =
	when (type) {
...
private fun getAudioTrack(stream: MediaStream) =
...
private fun getVideoTrack(stream: MediaStream) =
