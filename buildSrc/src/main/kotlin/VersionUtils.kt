 ...
 * It will look for a environment variable called VEGAFOX_VERSION first.
 * Next it will look for a property called "vegafox.version" and lastly it will use the fallback.
