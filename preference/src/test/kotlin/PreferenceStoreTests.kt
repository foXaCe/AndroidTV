...
private class TestStub : PreferenceStore<Unit, Unit>() {
	...
	override fun <T : Enum<T>> getEnum(preference: Preference<T>): T = (this.enum ?: preference.defaultValue) as T
	...
	override fun <T : Any> delete(preference: Preference<T>): Unit = throw NotImplementedError("Not required for tests")

	override fun runMigrations(body: MigrationContext<Unit, Unit>.() -> Unit): Unit = throw NotImplementedError("Not required for tests")
}
