...
interface VideoPlayerController {
	...
	// Overlay control (replaces direct LeanbackOverlayFragment access)
	fun setOverlayFading(enabled: Boolean)
	fun hideOverlay()

	// Master overlay access (needed by actions that show dialogs)
	val masterOverlayFragment: CustomPlaybackOverlayFragment
}
