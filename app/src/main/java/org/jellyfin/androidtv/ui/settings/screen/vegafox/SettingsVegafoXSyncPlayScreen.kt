...
@Composable
fun SettingsVegafoXSyncPlayScreen() {
	...
	SettingsColumn {
		item {
			Text(
				text = stringResource(R.string.pref_syncplay_settings),
		...
		item {
			...
			ListButton(
				...
				onClick = { router.push(Routes.VEGAFOX_SYNCPLAY_MIN_DELAY) },
			)
		}
		...
		item {
			...
			ListButton(
				...
				enabled = useSpeedToSync,
				onClick = { router.push(Routes.VEGAFOX_SYNCPLAY_MAX_DELAY) },
			)
		}
		...
		item {
			...
			ListButton(
				...
				enabled = useSpeedToSync,
				onClick = { router.push(Routes.VEGAFOX_SYNCPLAY_DURATION) },
			)
		}
		...
		item {
			...
			ListButton(
				...
				onClick = { router.push(Routes.VEGAFOX_SYNCPLAY_MIN_DELAY_SKIP) },
			)
		}
		...
		item {
			...
			ListButton(
				...
				onClick = { router.push(Routes.VEGAFOX_SYNCPLAY_EXTRA_OFFSET) },
			)
		}
	}
}
