...
/**
 * Rating entry returned by the VegafoX plugin's `/VegafoX/MdbList/Ratings` endpoint.
 */
@Serializable
...
/**
 * Response wrapper from the VegafoX plugin MDBList proxy.
 */
@Serializable
...
/**
 * Fetches MDBList ratings via the VegafoX server plugin proxy.
 *
 * Endpoint: `GET {serverUrl}/VegafoX/MdbList/Ratings?type={movie|show}&tmdbId={id}`
