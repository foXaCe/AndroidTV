...
fun SeriesTimerInfoDto.getSeriesOverview(context: Context) =
	buildString {
		if (recordNewOnly == true) {
			appendLine(context.getString(R.string.lbl_record_only_new))
		} else {
			appendLine(context.getString(R.string.lbl_record_all))
		}

		if (recordAnyChannel == true) {
			appendLine(context.getString(R.string.lbl_on_any_channel))
		} else {
			appendLine(context.getString(R.string.lbl_on_channel, channelName))
		}
