...
abstract class ListAdapter<T, VH : RecyclerView.ViewHolder> : RecyclerView.Adapter<VH>() {
				...
				DiffUtil.calculateDiff(
					object : DiffUtil.Callback() {
						...
						override fun areItemsTheSame(
							oldItemPosition: Int,
							newItemPosition: Int,
						): Boolean = areItemsTheSame(_items[oldItemPosition], newItems[newItemPosition])

						override fun areContentsTheSame(
							oldItemPosition: Int,
							newItemPosition: Int,
						): Boolean = areContentsTheSame(_items[oldItemPosition], newItems[newItemPosition])
					},
				)
	...
	protected open fun areItemsTheSame(
		old: T,
		new: T,
	): Boolean = areContentsTheSame(old, new)
	...
	override fun onBindViewHolder(
		holder: VH,
		position: Int,
	) = onBindViewHolder(holder, _items[position])
